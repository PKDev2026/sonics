export default function TicketRegistry() {
  return (
    // changed 'p-6 lg:p-20' to 'p-4 lg:p-8' to save vertical space
    <main className="relative h-full bg-gray-50 p-4 lg:p-8 flex items-center justify-center overflow-hidden">
      ...
      {/* Reduced max-width from 4xl to 2xl for a more compact "Card" look */}
      <div className="relative z-10 max-w-2xl w-full mx-auto">
        ...
        {/* THE REGISTRY FORM - Reduced padding from p-12 to p-8 */}
        <div className="relative bg-white border-4 border-sonics-green p-6 md:p-8 shadow-[16px_16px_0px_0px_#00653a]">
          ...
          <form className="space-y-5">
            {/* Name and Email Stacked for better verticality */}
            ...
            {/* High-impact, lower-profile button */}
